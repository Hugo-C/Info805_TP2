...
{
    Vector3 pc = center - ray.origin; //Vector3(center[0] - ray.origin[0], center[1] - ray.origin[1], center[2] - ray.origin[2]);
    ...
    Vector3 cp = Vector3(-pc[0], -pc[1], -pc[2]);
    Real b = 2 * (ray.direction.dot(cp));
